...
@MapperScan("com.glenncai.openbiplatform.aikey.mapper")
@ComponentScan("com.glenncai.openbiplatform") // scan all packages like common module
@EnableAspectJAutoProxy(proxyTargetClass = true, exposeProxy = true)
@EnableEurekaClient
@Slf4j
public class AiKeyApplication {

  public static void main(String[] args) throws UnknownHostException {
    SpringApplication application = new SpringApplication(AiKeyApplication.class);
